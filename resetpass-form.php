<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="resetpasswordform" id="resetpasswordform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'resetpass' ); ?>" method="post">
		...
		<div class="form-row">
			<label for="pass1<?php $template->the_instance(); ?>"><?php _e( 'New password', 'hhh-theme' ); ?></label>
		...
		<div class="form-row">
			<label for="pass2<?php $template->the_instance(); ?>"><?php _e( 'Confirm new password', 'hhh-theme' ); ?></label>
		...
		<div id="pass-strength-result" class="hide-if-no-js"><?php _e( 'Strength indicator', 'hhh-theme' ); ?></div>

		<div class="form-row">
			<p class="description indicator-hint"><?php _e( 'Hint: The password should be at least seven characters long. To make it stronger, use upper and lower case letters, numbers and symbols like ! " ? $ % ^ &amp; ).', 'hhh-theme' ); ?></p>
		</div>
